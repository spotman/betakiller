...
class Model_AdminContentEntity extends ORM
{
    const ARTICLES_ENTITY_ID = 1;

    protected $_table_name = 'admin_content_entities';
    ...
    {
        return __('admin.content.entities.'.$this->get_slug());
    }

    /**
     * Возвращает инстанс связанной модели
     * 
     * @return HasAdminContentInText
     * @throws Exception
     * @throws Kohana_Exception
     */
    public function get_related_model_instance()
    {
        ...
        $target_class = HasAdminContent::class;

...
abstract class Mango_Core implements Mango_Interface {
	 ...
	 * @param   $values array   values to pre-populate the model
	 * @param   $load_type integer use values to extend only, don't prepopulate model
	 * @return  static
	 */
	 ...
	 *
	 * @param   mixed  $limit limit the (maximum) number of models returned
	 * @param   array  $sort sorts models on specified fields array( field => 1/-1 )

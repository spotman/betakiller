...
abstract class Service_Content_Base extends \BetaKiller\Service
{
    ...
    /**
     * @return ContentElementInterface|\BetaKiller\Content\ImportedFromWordpressInterface
     */
    ...
    public function make_custom_html_tag(ContentElementInterface $content, $target_width = NULL, $target_height = NULL, array $attributes = [])
    {
        $attributes += [
            'width'     =>  $target_width,

    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "       <label for='' class='select2-offscreen'></label>",
                "       <input type='text' search='off' autocorrect='off' autocapitalize='off' spellcheck='false' class='select2-input' role='combobox' aria-expanded='true'",
                "       aria-search='list' />",
                "   </div>",
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "    <label for='' class='select2-offscreen'></label>",
                "    <input type='text' search='off' autocorrect='off' autocapitalize='off' spellcheck='false' class='select2-input'>",
                "  </li>",
                "</ul>",
